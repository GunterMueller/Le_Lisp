...
ffpmul2 move.b d7,d5     prepare sign/exponent work       4
       ...
       swap d5        save final s+exp in high word    4
       ...
       mulu d7,d4     d4 = arg2lowb x arg1lowb         38-54 (46)
       swap d4        place result in low word         4
       move.l d7,d3     copy arg2                        4
       swap d3        to arg2highw                     4
       mulu d5,d3     d3 = arg1lowb x arg2highw        38-54 (46)
       add.l  d3,d4     d4 = partial product (no carry)  8
       swap d6        to arg1 high two bytes           4
       move.l d6,d3     copy arg1highw over              4
       mulu d7,d3     d3 = arg2lowb x arg1highw        38-54 (46)
       ...
       mulu d6,d7     d7 = arg1highw x arg2highw       40-70 (54)
       swap d6        restore arg1                     4 
       swap d5        restore s+exp to low word
