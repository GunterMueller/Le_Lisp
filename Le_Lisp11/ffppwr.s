...
* ?          opt       pcs
 ...
 entry      ffppwr                        entry point
 
 extern      ffplog,ffpexp   exponent and log functions
 extern      ffpmul            multiply function
...
ffppwr   tst.b     d7                  Q negative base value
...
fpppos   jsr       ffplog              find log of the number to be used
         movem.l   d3-d5,-(a7)         save multiply work registers
	 jsr       ffpmul              multiply by the exponent
         movem.l   (a7)+,d3-d5         restore multiply work registers
