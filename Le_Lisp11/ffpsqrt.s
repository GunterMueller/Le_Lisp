...
ffpsqrt  move.b    d7,d3     copy s+exponent over
         ...
         bmi.s     fpsinv    negative, reject with a7ecial condition codes
         lsr.b     #1,d3     divide exponent by two
         bcc.s     fpseven   branch exponent was even
         addi.b     #1,d3     adjust odd values up by one
         lsr.l     #1,d7     offset odd exponent's mantissa one bit
fpseven  addi.b     #$20,d3   renormalize exponent
         ...
         subi.l     #$01200000,d5 combine first loop calculations
...
* all 24 bits calculated. now test result of 25th bit
         ...
         addi.l     #1,d7     round up (cannot overflow)
